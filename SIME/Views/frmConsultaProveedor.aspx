            ...
            <ContentTemplate>
                ...
                <div width="100%" class="row">
                    <dx:BootstrapGridView ID="gvProveedores" runat="server" KeyFieldName="Id_Prov">
                        ...
                        <Columns>
                            <dx:BootstrapGridViewDataColumn FieldName="Proveedor" Caption="Nombre / Razón Social" VisibleIndex="1" CssClasses-DataCell="hideColumn" CssClasses-HeaderCell="hideColumn" />
