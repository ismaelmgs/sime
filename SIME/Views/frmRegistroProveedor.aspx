<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmRegistroProveedor.aspx.cs" Inherits="SIME.Views.frmRegistroProveedor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    ...
    <div class="container-fluid">
        <div style="margin-left: 2%;">
            <br />
            <h5 class="page-title rlrH5" style="margin-left: -2%; margin-bottom: 1%; font-weight: bold;">Registro de proveedores</h5>
            <br />
        ...
        <fieldset style="width: 100%; padding: 15px; margin-top: -40px; margin-bottom: 40px" class="card mb-4">
            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                    <dx:BootstrapDateEdit ID="txtFec_Nac" runat="server"></dx:BootstrapDateEdit>
                </div>
                <div class="col-lg-2"></div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-2">
                    <dx:BootstrapTextBox ID="txtRFC" runat="server" Text=""></dx:BootstrapTextBox>
                </div>
                <div class="col-lg-1"></div>
                <div class="col-lg-2">
            ...
            <div class="col-lg-6">
                <fieldset style="width: 100%; padding: 15px; margin-top: -40px;" class="card mb-4">
                    ...
                    <div class="row">
                        <div class="col-lg-2"></div>
                        <div class="col-lg-4">
                            <asp:Label runat="server" Text="Nombre Contacto:"></asp:Label>
                        </div>
                        <div class="col-lg-4">
