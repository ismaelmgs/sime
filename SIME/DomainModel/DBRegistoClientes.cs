...
{
    public class DBRegistoClientes : DBBase
    {
        public DataTable DBInsertaCliente(Registro oRegistro)
        {
            try
            {
                return oDB_SP.EjecutarDT("[sp_Inserta_Clientes]"
        ...
        public Registro DBGetObtieneClientePorId(int iIdCliente)
        {
            try
            {
                return oDB_SP.EjecutarDT("[dbo].[spS_ConsultaClientePorId]", "@Id_Cliente", iIdCliente).AsEnumerable().Select(r => new Registro()
                {
        ...
        public bool DBSetActualizaClientePersonaFisica(Registro oRegistro)
        {
            try
            {
                object oRes = oDB_SP.EjecutarValor("[dbo].[spU_ActualizaClientePersonaFisica]", "@Id_Cliente", oRegistro.iIdCliente,
                                                                                                "@Primer_Nombre", oRegistro.Primer_Nombre,
                                                                                                "@Segundo_Nombre", oRegistro.Segundo_Nombre,
                                                                                                "@App_Pat", oRegistro.App_Pat,
                                                                                                "@App_Mat", oRegistro.App_Mat,
        ...
        public bool DBSetActualizaClientePersonaMoral(Registro oRegistro)
        {
            try
            {
                object oRes = oDB_SP.EjecutarValor("[dbo].[spU_ActualizaClientePersonaMoral]", "@Id_Cliente", oRegistro.iIdCliente,
                                                                                                "@Razon_Social", oRegistro.Razon_Social,
                                                                                                "@RFC", oRegistro.RFC,
                                                                                                "@Sector", oRegistro.Sector,
                                                                                                "@Calle", oRegistro.Calle,
